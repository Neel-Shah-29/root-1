...
ParserFuncSignature ParseLog = [](RModelParser_ONNX &parser, const onnx::NodeProto &nodeproto) {
   ...
   if (parser.IsRegisteredTensorType(input_name)) {
      ...
      throw std::runtime_error("TMVA::SOFIE ONNX Parser Log op has input tensor" + input_name +
   ...
   switch (input_type) {
   case ETensorType::FLOAT: op.reset(new ROperator_Log<float>(input_name, output_name)); break;
   default:
